...
profile_handler = HaloProfileHandler(['matter', 'cdm', 'gas', 'star'], files)
...
def get_binned_profiles(m_min, m_max, n_bins):
	...
	for i in range(len(mass_bin_edges)-1):
		...
		cdm_profs = profile_handler.get_masked_profile(mmin, mmax, 20, 'cdm')
		gas_profs = profile_handler.get_masked_profile(mmin, mmax, 20, 'gas')
		star_profs = profile_handler.get_masked_profile(mmin, mmax, 20, 'star')
		...
		mean_profiles_cdm.append([cdm_mean_prof, cdm_mean_r, cdm_mean_x])
		mean_profiles_gas.append([gas_mean_prof, gas_mean_r, gas_mean_x])
		mean_profiles_star.append([star_mean_prof, star_mean_r, star_mean_x])
	...
	return mean_profiles_matter, mean_profiles_cdm, mean_profiles_gas, mean_profiles_star, mean_rvirs, mean_mvirs, Nhalos